<template>
  <div class="mt-3">
    <div class="flex gap-4">
      ...
      <h1 class="text-2xl">Edit New User</h1>
    </div>
...
const getUser = () => {
  const user = userStore.getUserById(Number(route.params.userId))
  if (user) {
    formData.value = { ...user }
  }
}
